...
function Modal({isOpen,title,onClose,children}) {
    ...
    return (
        isOpen && (<div className="backdrop-blur-sm bg-secondary-400/50 fixed top-0 left-0 w-full h-screen z-10">
            <div ref={modalRef}  className="w-[calc(100vw-3rem)] sm:max-w-md lg:max-w-lg max-h-[calc(100vh-1rem)] overflow-y-auto bg-secondary-0 flex flex-col fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-2 rounded-lg shadow-lg shadow-secondary-200  ">
